          		...
          		<div class="col-12 row">
          			...
          			<div class="col-12 row mt-3">
          				<div class="col-4 row">
          					...
          					<div class="col-9">
          						<p class="tomoru-font-5">40% вопросов решает сам</p>
          					</div>
          					<div class="col-12">
          				...
          				<div class="col-4 row">
          					...
          					<div class="col-9">
          						<p class="tomoru-font-5">80% сообщений распознает</p>
          					</div>
          					<div class="col-12">
          				...
          				<div class="col-4 row">
          					...
          					<div class="col-9">
          						<p class="tomoru-font-5">Начинает работать за 99 дней</p>
          					</div>
          					<div class="col-12">
          						<p class="tomoru-font-3">Если через 999 дней мы не запустили бота, мы начинает возвращать вам деньги</p>
          					</div>
          				</div>
          			</div>
          			<div class="col-12 row">
