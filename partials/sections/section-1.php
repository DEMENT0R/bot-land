          <div class="bg_all bg_1 row">
              ...
              <div class="col-12 col-md-5 offset-md-2 row text-left">
                <h2 class="tomoru-font-1">Поддерживают диалог с клиентами</h2>
                ...
                <div class="col-12 col-md-4"><a href="#" class="tomoru-font-3 tomoru-btn-1">Создать бота</a></div>
                <div class="col-12 col-md-8"><p class="tomoru-font-3 pt-2">* В среднем, в сравнении с человеком</p></div>
                
                
              </div>
              <div class="col-12 col-md-4 tomoru-img-block tomoru-img-block-phone d-none d-md-block">
