        					...
        					<div class="col-12 row">
          					...
          					<div class="col-12 row">
          						<p class="tomoru-font-3">
          							Lorem ipsum dolor sit amet, consectetur adipisicing elit. Illum deleniti, aspernatur obcaecati repellendus sequi, eos eaque expedita odio saepe quos, deserunt similique! Beatae incidunt fuga dolorum placeat consectetur vel sed.
          						</p>
          					</div>
          				</div>
          				<div class="col-12 col-md-4">
          					<p class="tomoru-font-3">
          						<span style="font-weight: 600;">100 000 ₽</span><br>
          						Стоимость внедрения (без учета вашей скидки)<br>
          						<span style="font-weight: 600;">6 ₽</span><br>
          						Стоимость минуты разговора<br>
          						<span style="font-weight: 600;">40%</span><br>
          						Возможная экономия на сотрудниках
          					</p>
          				</div>
          			</div>
          		</div>
